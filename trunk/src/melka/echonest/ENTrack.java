...
public class ENTrack {
	...
	public ENBar[] getBars() {
		if (bars == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_bars?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
	...
	public ENBeat[] getBeats() {
		if (beats == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_beats?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENDuration getDuration() {
		if (duration == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_duration?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENEndOfFadeIn getEndOfFadeIn() {
		if (endOfFadeIn == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_end_of_fade_in?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENKey getKey() {
		if (key == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_key?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENLoudness getLoudness() {
		if (loudness == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_loudness?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENMetadata getMetadata() {
		if (metadata == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_metadata?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENMode getMode() {
		if (mode == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_mode?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENSection[] getSections() {
		if (sections == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_sections?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENSegment[] getSegments() {
		if (segments == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_segments?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENStartOfFadeOut getStartOfFadeOut() {
		if (startOfFadeOut == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_start_of_fade_out?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENTatum[] getTatums() {
		if (tatums == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_tatums?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENTempo getTempo() {
		if (tempo == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_tempo?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
	...
	public ENTimeSignature getTimeSignature() {
		if (timeSignature == null) {
			XMLElement data = new XMLElement(parent,getBaseUrl()+"get_time_signature?api_key="+getApiKey()+"&md5="+getTrackMD5()+"&version=3");
			if (Integer.parseInt(data.getChild("status").getChild("code").getContent()) == SUCCESS) {
